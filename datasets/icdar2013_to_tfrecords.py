...
if __name__ == "__main__":
    ...
    cvt_to_tfrecords(output_path=util.io.join_path(output_dir, 'icdar2013_train.tfrecord'), data_path=training_data_dir,
                     gt_path=training_gt_dir)
    cvt_to_tfrecords(output_path=util.io.join_path(output_dir, 'icdar2013_test.tfrecord'), data_path=test_data_dir,
                     gt_path=test_gt_dir)
